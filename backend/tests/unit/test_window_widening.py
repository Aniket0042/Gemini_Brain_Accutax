...
@pytest.mark.parametrize("name,params,expect_retries", [
    ...
    ("today",             {"start_date": "2026-08-28", "end_date": "2026-08-28"}, False),
    ("today camelCase",   {"startDate": "2026-08-28", "endDate": "2026-08-28"}, False),
...
def test_widened_params_keeps_camel_case_aliases():
    original = {"startDate": "2026-08-01", "endDate": "2026-08-31", "start_date": "2026-08-01"}
    out = widened_params(original, "2026-05-30", "2026-08-28")
    assert out["startDate"] == "2026-05-30"
    assert out["endDate"] == "2026-08-28"
    assert out["start_date"] == "2026-05-30"
