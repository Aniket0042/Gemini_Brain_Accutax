...
# Location is configurable; the previous hardcoded "/root/..." only ever
# resolved on one developer's machine, so schema grounding was silently off
# everywhere else — which degrades the SQL the model writes.
_FALLBACK_PATH = os.environ.get("SCHEMA_DESCRIPTION_PATH", "")
