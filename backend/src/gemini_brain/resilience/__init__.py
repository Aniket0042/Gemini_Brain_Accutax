...
from .output_guard import sanitize_answer, looks_like_backend_leak, strip_emojis, strip_invented_turns
...
__all__ = [
    ...
    "new_request_id",
    "sanitize_answer", "looks_like_backend_leak", "strip_emojis", "strip_invented_turns",
]
