...
- For /accounting/journal-entries: use userId and organizationId (both camelCase) plus startDate and endDate (YYYY-MM-DD). For "posted today" both dates are {today}.
