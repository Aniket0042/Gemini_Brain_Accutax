...
echo "  4. Install the nginx site (uses this instance's own DNS name as"
echo "     server_name so it coexists with the existing 'accutax' site --"
echo "     see deploy/nginx-gemini-brain.conf):"
...
echo "  5. Get a free TLS cert for that same DNS name:"
echo "       sudo certbot --nginx -d ec2-13-205-100-89.ap-south-1.compute.amazonaws.com"
echo "  6. Visit https://ec2-13-205-100-89.ap-south-1.compute.amazonaws.com/"
echo "========================================================================"
