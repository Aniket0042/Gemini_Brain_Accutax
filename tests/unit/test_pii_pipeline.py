...
def test_pipeline_redaction_e2e():
    ...
    raw_query = "My email is john.doe@acme.com and my phone is +971 50 123 4567, show total sales for 2026."
    ...
    runner._call_gemini = mock_gemini
    ...
    with patch("gemini_brain.orchestrator.gemini_brain_runner.classify_intent", return_value=({"type": 4, "reason": "data_query"}, 10, 10)) as mock_classify, \
         ...
         patch("gemini_brain.orchestrator.gemini_brain_runner.call_api", return_value=(True, {"total": 100000.00})), \
         patch("gemini_brain.orchestrator.gemini_brain_runner.judge_complexity", return_value=("SIMPLE", 10, 10)) as mock_complexity, \
